...
# ループ設計上の役割: ゴール型ループの「定量的停止条件」。詳細は docs/ops/loop_design.md 参照。
...
PAIRS=(
  ...
  "marketing/beauty_2040_lp.html:public/beauty2040/index.html"
  "marketing/pureline_lp.html:public/pureline/index.html"
)
